...
const contentSecurityPolicy = [
  ...
  "script-src 'self' 'unsafe-inline' https://accounts.google.com https://apis.google.com https://www.googletagmanager.com https://www.google-analytics.com https://www.googleadservices.com https://www.google.com https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net",
  "style-src 'self' 'unsafe-inline'",
  `connect-src ${Array.from(cspConnectSrcAllowlist).join(' ')}`,
  "frame-src 'self' https://www.google.com https://maps.google.com https://accounts.google.com https://www.googletagmanager.com https://bid.g.doubleclick.net",
...
const securityHeaders = [
  ...
  { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=(), attribution-reporting=()' },
